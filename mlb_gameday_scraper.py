...
def individual_game(url, game_info_list, game_link_id):
        ...
        for individual_innings in soup.find_all('inning'):
                ...
                for atbat in individual_innings.find_all('atbat'):
                        ...
                        for pitch in atbat.find_all('pitch'):
                                ...
                                pitch_info = game_info_list + ab_info + [p_description, id_, type_, code, p_time, x, y, event_num, start_speed, end_speed, on_first, \
        ...
        df = pd.DataFrame(data, columns = ['season_period', 'home', 'league_home', 'away', 'league_away', 'stadium', 'location', 'game_id', 'inning', 'ab_game_num', \
